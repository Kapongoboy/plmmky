...
impl<'a> Lexer<'a> {
    ...
    fn read_number(&mut self) -> Token {
        ...
        let loc = if self.repl { None } else { Some(token::Location::new(self.curr_line, self.curr_col, self.path.expect("There is a problem with the file"))) };
        ...
        match file {
            Ok(s) => {
                ...
                let test_arr = [
                    ...
                    Token::new(TokenKind::IDENT(String::from("five")), Some(Location::new(1, 5, path))),
                    ...
                    Token::new(TokenKind::IDENT(String::from("ten")), Some(Location::new(2, 5, path))),
                    ...
                    Token::new(TokenKind::IDENT(String::from("add")), Some(Location::new(3, 5, path))),
                    ...
                    Token::new(TokenKind::IDENT(String::from("x")), Some(Location::new(3, 21, path))),
                    Token::new(TokenKind::COMMA, Some(Location::new(3, 22, path))),
                    Token::new(TokenKind::IDENT(String::from("y")), Some(Location::new(3, 24, path))),
                    Token::new(TokenKind::RPAREN, Some(Location::new(3, 25, path))),
                    Token::new(TokenKind::LBRACE, Some(Location::new(3, 27, path))),
                    Token::new(TokenKind::IDENT(String::from("x")), Some(Location::new(4, 5, path))),
                    Token::new(TokenKind::PLUS, Some(Location::new(4, 7, path))),
                    Token::new(TokenKind::IDENT(String::from("y")), Some(Location::new(4, 9, path))),
                    ...
                    Token::new(TokenKind::IDENT(String::from("result")), Some(Location::new(7, 5, path))),
                    Token::new(TokenKind::ASSIGN, Some(Location::new(7, 12, path))),
                    Token::new(TokenKind::IDENT(String::from("add")), Some(Location::new(7, 14, path))),
                    Token::new(TokenKind::LPAREN, Some(Location::new(7, 17, path))),
                    Token::new(TokenKind::IDENT(String::from("five")), Some(Location::new(7, 18, path))),
                    Token::new(TokenKind::COMMA, Some(Location::new(7, 23, path))),
                    Token::new(TokenKind::IDENT(String::from("ten")), Some(Location::new(7, 25, path))),
